...
import CurrentUserTracksEndpoints from "./endpoints/CurrentUserEndpoints.js";
...
export class SpotifyApi {
    ...
    public currentUserTracksEndpoint: CurrentUserTracksEndpoints;
    ...
    public constructor(authentication: IAuthStrategy, config?: SdkOptions) {
        ...
        this.currentUserTracksEndpoint =new CurrentUserTracksEndpoints(this);
